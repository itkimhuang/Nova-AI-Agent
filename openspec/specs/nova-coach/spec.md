...
## Purpose
Define the observable behavior for Nova, a local personal study and project coach that helps the user choose small daily actions, keep lightweight progress memory, and avoid overwhelming plans.
